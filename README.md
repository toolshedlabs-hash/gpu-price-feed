...
<!-- BEGIN GENERATED -->
Last checked **2026-08-28T18:41:37Z**. 508 live offers from 8 providers.
...
| $6.28 | Vast.ai | B200 | not stated | nobody says | 1 | on-demand |
...
| $3.70 | Vast.ai | H100 SXM | SXM | the provider says so | 1 | on-demand |
...
| $2.80 | Vast.ai | H100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.657 | Vast.ai | A100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.13 | Vast.ai | RTX PRO 6000 S | Server | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.863 | Vast.ai | RTX PRO 6000 WS | Workstation | the provider says so | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 177 | 74 | ok | https://console.vast.ai/api/v0/search/asks/ |
