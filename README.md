...
<!-- BEGIN GENERATED -->
Last checked **2026-07-30T12:14:42Z**. 460 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-07-29, 1 EUR = 1.1380 USD.
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.428 | Vast.ai | L40S | PCIe | only made in one form | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 163 | 65 | ok | https://console.vast.ai/api/v0/search/asks/ |
