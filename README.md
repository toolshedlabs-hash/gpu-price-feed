...
<!-- BEGIN GENERATED -->
Last checked **2026-07-26T11:10:25Z**. 465 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-07-24, 1 EUR = 1.1377 USD.
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $5.87 | Vast.ai | B200 | not stated | nobody says | 1 | on-demand |
| $5.89 | RunPod | NVIDIA B200 | not stated | nobody says | 1 | on-demand |

### H200 141GB SXM

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.44 | DigitalOcean | NVIDIA HGX H200 | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $2.94 | Vast.ai | H200 NVL | NVL | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.92 | Vast.ai | H100 SXM | SXM | the provider says so | 1 | on-demand |
...
| $3.39 | DigitalOcean | NVIDIA HGX H100 | SXM | the provider says so | 1 | on-demand |
| $3.77 * | Scaleway | H100-SXM | SXM | the provider says so | 2 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.73 | Vast.ai | H100 PCIE | PCIe | the provider says so | 8 | on-demand |
| $1.99 | RunPod | NVIDIA H100 PCIe | PCIe | the provider says so | 1 | on-demand |
| $3.26 * | Scaleway | H100-PCIe | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.74 | Vast.ai | H100 NVL | NVL | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.550 | Vast.ai | A100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.602 | Vast.ai | A100 SXM4 | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.429 | Vast.ai | A100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.922 | Vast.ai | RTX PRO 6000 WS | Workstation | the provider says so | 1 | on-demand |
...
| $0.801 | Vast.ai | L40S | PCIe | only made in one form | 1 | on-demand |
...
| $1.67 * | Scaleway | L40S | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.536 | Vast.ai | RTX 6000Ada | PCIe | only made in one form | 1 | on-demand |
...
| $0.669 | Vast.ai | RTX A6000 | PCIe | only made in one form | 1 | on-demand |
...
| $1.71 | Vultr | NVIDIA_A40 | PCIe | only made in one form | 1 | on-demand |

### RTX 5090 32GB

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.274 | Vast.ai | RTX 5090 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.263 | Vast.ai | RTX 4090 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.122 | Vast.ai | RTX 3090 | not stated | nobody says | 1 | on-demand |
...
| $0.390 | RunPod | NVIDIA L4 | PCIe | only made in one form | 1 | on-demand |
| $0.896 * | Scaleway | L4 | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.202 | Vast.ai | A10 | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $2.14 | DataCrunch | B200 SXM6 180GB | SXM | the provider says so | 2 | spot |

### B200 180GB (form unstated) (spot)

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $5.49 | RunPod | NVIDIA B200 | not stated | nobody says | 1 | spot |

### H200 141GB SXM (spot)

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.40 | DataCrunch | H200 SXM5 141GB | SXM | the provider says so | 1 | spot |
| $3.99 | RunPod | NVIDIA H200 | SXM | the provider says so | 1 | spot |

### H100 80GB SXM (spot)

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.14 | DataCrunch | H100 SXM5 80GB | SXM | the provider says so | 2 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.626 | DataCrunch | A100 SXM4 80GB | SXM | the provider says so | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.452 | DataCrunch | A100 SXM4 40GB | SXM | the provider says so | 1 | spot |

### RTX PRO 6000 Blackwell 96GB Server (spot)

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.89 | RunPod | NVIDIA RTX PRO 6000 Blackwell Server Edition | Server | the provider says so | 1 | spot |

### RTX PRO 6000 Blackwell 96GB Workstation (spot)

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.89 | RunPod | NVIDIA RTX PRO 6000 Blackwell Workstation Edition | Workstation | the provider says so | 1 | spot |

### RTX PRO 6000 Blackwell 96GB (form unstated) (spot)

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.661 | DataCrunch | RTX PRO 6000 96GB | not stated | nobody says | 1 | spot |
| $0.675 | DataCrunch | RTX PRO 6000 CC 96GB | not stated | nobody says | 1 | spot |

### L40S 48GB (spot)

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.479 | DataCrunch | L40S 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.364 | DataCrunch | RTX 6000 Ada 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.213 | DataCrunch | RTX A6000 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.990 | RunPod | NVIDIA GeForce RTX 5090 | not stated | nobody says | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.390 | RunPod | NVIDIA L4 | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.0595 | DataCrunch | Tesla V100 16GB | not stated | nobody says | 1 | spot |
...
| [RunPod](https://www.runpod.io) | 121 | 44 | ok | https://api.runpod.io/graphql |
| [Scaleway](https://www.scaleway.com) | 20 | 5 | ok | https://api.scaleway.com/instance/v1/zones/{zone}/products/servers |
| [Vast.ai](https://vast.ai) | 164 | 65 | ok | https://console.vast.ai/api/v0/search/asks/ |
...
Vast.ai is the one that needs a number on it. This run asked for 62 GPU names, 35 of which came from sampling the live marketplace rather than from the built in list, and 0 of them had no verified stock. Anything Vast rents under a name outside that set is not in this table.

Full data for all 86 GPU models we saw this run is in [`data/prices.json`](data/prices.json).
<!-- END GENERATED -->
