...
<!-- BEGIN GENERATED -->
Last checked **2026-09-16T11:32:31Z**. 324 live offers from 7 providers.

Euro prices converted at the ECB reference rate published 2026-09-15, 1 EUR = 1.1539 USD.

> Not included in this run because the collector could not read them: Vast.ai. Rather than show you a stale number we show nothing.
...
| $6.36 | DataCrunch | B200 SXM6 180GB | SXM | the provider says so | 2 | on-demand |
...
| $4.28 | DataCrunch | H200 SXM5 141GB | SXM | the provider says so | 8 | on-demand |
...
| $3.28 | DataCrunch | H100 SXM5 80GB | SXM | the provider says so | 1 | on-demand |
| $3.68 * | Scaleway | H100-SXM | SXM | the provider says so | 4 | on-demand |
...
| $1.72 | DataCrunch | A100 SXM4 80GB | SXM | the provider says so | 8 | on-demand |
...
| $1.43 | DataCrunch | L40S 48GB | PCIe | only made in one form | 1 | on-demand |
...
| $1.08 | DataCrunch | RTX 6000 Ada 48GB | PCIe | only made in one form | 1 | on-demand |
...
| $0.909 * | Scaleway | L4 | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.172 | DataCrunch | Tesla V100 16GB | not stated | nobody says | 1 | on-demand |
...
| $3.18 | DataCrunch | B200 SXM6 180GB | SXM | the provider says so | 4 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $2.14 | DataCrunch | H200 SXM5 141GB | SXM | the provider says so | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.64 | DataCrunch | H100 SXM5 80GB | SXM | the provider says so | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.859 | DataCrunch | A100 SXM4 80GB | SXM | the provider says so | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.713 | DataCrunch | L40S 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.541 | DataCrunch | RTX 6000 Ada 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.0860 | DataCrunch | Tesla V100 16GB | not stated | nobody says | 1 | spot |
...
| [Vast.ai](https://vast.ai) | 0 | 0 | error | vastai B300 PC price_total_hr_usd = 256.0015 is outside $0.005..$200 per hour |
...
Full data for all 58 GPU models we saw this run is in [`data/prices.json`](data/prices.json).
<!-- END GENERATED -->
