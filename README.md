...
<!-- BEGIN GENERATED -->
Last checked **2026-07-24T12:00:24Z**. 468 live offers from 8 providers.
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.62 | Vast.ai | H200 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.936 | Vast.ai | RTX PRO 6000 WS | Workstation | the provider says so | 1 | on-demand |
...
| $0.804 | Vast.ai | L40S | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.308 | Vast.ai | RTX 5090 | not stated | nobody says | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 167 | 65 | ok | https://console.vast.ai/api/v0/search/asks/ |
...
Full data for all 89 GPU models we saw this run is in [`data/prices.json`](data/prices.json).
<!-- END GENERATED -->
