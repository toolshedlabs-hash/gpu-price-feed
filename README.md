...
<!-- BEGIN GENERATED -->
Last checked **2026-07-31T13:09:28Z**. 461 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-07-30, 1 EUR = 1.1476 USD.
...
| $7.56 | Vast.ai | B200 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.13 | Vast.ai | H200 NVL | NVL | the provider says so | 1 | on-demand |
...
| $2.80 | Vast.ai | H100 SXM | SXM | the provider says so | 1 | on-demand |
...
| $3.80 * | Scaleway | H100-SXM | SXM | the provider says so | 2 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.882 | Vast.ai | RTX PRO 6000 WS | Workstation | the provider says so | 1 | on-demand |
...
| $0.403 | Vast.ai | RTX A6000 | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.109 | Vast.ai | RTX 3090 | not stated | nobody says | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 164 | 63 | ok | https://console.vast.ai/api/v0/search/asks/ |
