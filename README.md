...
<!-- BEGIN GENERATED -->
Last checked **2026-07-29T13:11:10Z**. 453 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-07-28, 1 EUR = 1.1367 USD.
...
| $6.88 | Vast.ai | B200 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.34 | Vast.ai | H200 NVL | NVL | the provider says so | 1 | on-demand |
...
| $3.76 * | Scaleway | H100-SXM | SXM | the provider says so | 2 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $2.00 | Vast.ai | H100 NVL | NVL | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.523 | Vast.ai | A100 SXM4 | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.469 | Vast.ai | A100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.876 | Vast.ai | RTX PRO 6000 WS | Workstation | the provider says so | 1 | on-demand |
...
| $0.430 | Vast.ai | RTX A6000 | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.276 | Vast.ai | RTX 4090 | not stated | nobody says | 1 | on-demand |
...
| $0.895 * | Scaleway | L4 | PCIe | only made in one form | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 156 | 62 | ok | https://console.vast.ai/api/v0/search/asks/ |
...
Vast.ai is the one that needs a number on it. This run asked for 60 GPU names, 33 of which came from sampling the live marketplace rather than from the built in list, and 1 of them had no verified stock. Anything Vast rents under a name outside that set is not in this table.

Full data for all 85 GPU models we saw this run is in [`data/prices.json`](data/prices.json).
<!-- END GENERATED -->
