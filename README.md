...
<!-- BEGIN GENERATED -->
Last checked **2026-09-15T11:43:24Z**. 493 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-09-14, 1 EUR = 1.1551 USD.
...
|---|---|---|---|---|---|---|
| $6.23 | DataCrunch | B200 CC SXM6 180GB | SXM | the provider says so | 4 | on-demand |
| $6.29 | DataCrunch | B200 SXM6 180GB | SXM | the provider says so | 8 | on-demand |
...
| $4.24 | DataCrunch | H200 SXM5 141GB | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.79 | Vast.ai | H200 NVL | NVL | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.98 | Vast.ai | H200 | not stated | nobody says | 1 | on-demand |

### H100 80GB SXM

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.87 | Vast.ai | H100 SXM | SXM | the provider says so | 1 | on-demand |
| $2.69 | RunPod | NVIDIA H100 80GB HBM3 | SXM | the provider says so | 1 | on-demand |
| $3.27 | DataCrunch | H100 SXM5 80GB | SXM | the provider says so | 4 | on-demand |
| $3.69 * | Scaleway | H100-SXM | SXM | the provider says so | 4 | on-demand |
...
| $2.54 | Vast.ai | H100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $1.73 | DataCrunch | A100 SXM4 80GB | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.429 | Vast.ai | A100 SXM4 | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.44 | Vast.ai | RTX PRO 6000 WS | Workstation | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.00 | Vast.ai | RTX PRO 6000 Max-Q | Max-Q | the provider says so | 1 | on-demand |
...
| $1.41 | DataCrunch | L40S 48GB | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.526 | Vast.ai | RTX 6000Ada | PCIe | only made in one form | 1 | on-demand |
| $0.740 | RunPod | NVIDIA RTX 6000 Ada Generation | PCIe | only made in one form | 1 | on-demand |
| $1.07 | DataCrunch | RTX 6000 Ada 48GB | PCIe | only made in one form | 1 | on-demand |
...
| $0.470 | Vast.ai | RTX A6000 | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.322 | Vast.ai | RTX 4090 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.312 | Vast.ai | L4 | PCIe | only made in one form | 1 | on-demand |
| $0.490 | RunPod | NVIDIA L4 | PCIe | only made in one form | 1 | on-demand |
| $0.910 * | Scaleway | L4 | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.171 | DataCrunch | Tesla V100 16GB | not stated | nobody says | 1 | on-demand |
...
| $3.15 | DataCrunch | B200 SXM6 180GB | SXM | the provider says so | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $2.12 | DataCrunch | H200 SXM5 141GB | SXM | the provider says so | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.63 | DataCrunch | H100 SXM5 80GB | SXM | the provider says so | 8 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.864 | DataCrunch | A100 SXM4 80GB | SXM | the provider says so | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.706 | DataCrunch | L40S 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.536 | DataCrunch | RTX 6000 Ada 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.0855 | DataCrunch | Tesla V100 16GB | not stated | nobody says | 1 | spot |
...
| [DataCrunch](https://datacrunch.io) | 102 | 12 | ok | https://api.datacrunch.io/v1/instance-types |
...
| [Vast.ai](https://vast.ai) | 169 | 70 | ok | https://console.vast.ai/api/v0/search/asks/ |
...
Vast.ai is the one that needs a number on it. This run asked for 73 GPU names, 46 of which came from sampling the live marketplace rather than from the built in list, and 3 of them had no verified stock. Anything Vast rents under a name outside that set is not in this table.
