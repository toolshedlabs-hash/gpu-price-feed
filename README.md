...
<!-- BEGIN GENERATED -->
Last checked **2026-09-20T11:22:49Z**. 501 live offers from 8 providers.
...
>   - vastai GTX 1660 6GB moved from $0.0704 to $0.6778 per GPU hour (9.6x, limit 5.0x)
>   - vastai RTX 2060 moved from $0.0693 to $0.4111 per GPU hour (5.9x, limit 5.0x)
...
| $9.39 | Vast.ai | B200 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.98 | Vast.ai | H100 SXM | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.442 | Vast.ai | A100 SXM4 | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.444 | Vast.ai | A100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.563 | Vast.ai | RTX 6000Ada | PCIe | only made in one form | 1 | on-demand |
...
| $0.456 | Vast.ai | RTX 4090 | not stated | nobody says | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 175 | 76 | anomaly | https://console.vast.ai/api/v0/search/asks/ |
