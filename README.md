...
<!-- BEGIN GENERATED -->
Last checked **2026-09-14T12:45:41Z**. 495 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-09-11, 1 EUR = 1.1592 USD.
...
|---|---|---|---|---|---|---|
| $6.23 | DataCrunch | B200 SXM6 180GB | SXM | the provider says so | 2 | on-demand |
...
| $4.20 | DataCrunch | H200 SXM5 141GB | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.49 | Vast.ai | H200 NVL | NVL | the provider says so | 1 | on-demand |
...
| $3.70 * | Scaleway | H100-SXM | SXM | the provider says so | 4 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.54 | Vast.ai | RTX PRO 6000 S | Server | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.45 | Vast.ai | RTX PRO 6000 WS | Workstation | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.83 | DataCrunch | RTX PRO 6000 96GB | not stated | nobody says | 8 | on-demand |
| $1.87 | DataCrunch | RTX PRO 6000 CC 96GB | not stated | nobody says | 1 | on-demand |
...
| $1.40 | DataCrunch | L40S 48GB | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.585 | Vast.ai | RTX 6000Ada | PCIe | only made in one form | 1 | on-demand |
| $0.740 | RunPod | NVIDIA RTX 6000 Ada Generation | PCIe | only made in one form | 1 | on-demand |
| $1.06 | DataCrunch | RTX 6000 Ada 48GB | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.356 | Vast.ai | RTX 5090 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.12 | DataCrunch | B200 SXM6 180GB | SXM | the provider says so | 4 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $2.10 | DataCrunch | H200 SXM5 141GB | SXM | the provider says so | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.916 | DataCrunch | RTX PRO 6000 96GB | not stated | nobody says | 1 | spot |
| $0.935 | DataCrunch | RTX PRO 6000 CC 96GB | not stated | nobody says | 1 | spot |

### L40S 48GB (spot)

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.699 | DataCrunch | L40S 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.530 | DataCrunch | RTX 6000 Ada 48GB | PCIe | only made in one form | 1 | spot |
...
| [Vast.ai](https://vast.ai) | 171 | 73 | ok | https://console.vast.ai/api/v0/search/asks/ |
...
Vast.ai is the one that needs a number on it. This run asked for 71 GPU names, 44 of which came from sampling the live marketplace rather than from the built in list, and 2 of them had no verified stock. Anything Vast rents under a name outside that set is not in this table.
