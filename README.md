...
<!-- BEGIN GENERATED -->
Last checked **2026-08-12T09:48:31Z**. 506 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-08-11, 1 EUR = 1.1540 USD.
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.58 | Vast.ai | H200 | not stated | nobody says | 1 | on-demand |

### H100 80GB SXM

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $2.01 | Vast.ai | H100 SXM | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.735 | Vast.ai | RTX PRO 6000 WS | Workstation | the provider says so | 1 | on-demand |
...
| $0.336 | Vast.ai | RTX A6000 | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.298 | Vast.ai | RTX 4090 | not stated | nobody says | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 179 | 71 | ok | https://console.vast.ai/api/v0/search/asks/ |
