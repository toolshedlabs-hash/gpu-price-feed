...
<!-- BEGIN GENERATED -->
Last checked **2026-09-23T11:35:25Z**. 479 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-09-22, 1 EUR = 1.1463 USD.
...
|---|---|---|---|---|---|---|
| $6.62 | DataCrunch | B200 SXM6 180GB | SXM | the provider says so | 2 | on-demand |
...
| $4.46 | DataCrunch | H200 SXM5 141GB | SXM | the provider says so | 4 | on-demand |
...
| $3.38 | DataCrunch | H100 SXM5 80GB | SXM | the provider says so | 1 | on-demand |
...
| $5.68 | Vast.ai | H100 SXM | SXM | the provider says so | 1 | on-demand |
...
| $3.00 | Vast.ai | H100 NVL | NVL | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.89 | DataCrunch | RTX PRO 6000 96GB | not stated | nobody says | 8 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.695 | Vast.ai | L40S | PCIe | only made in one form | 1 | on-demand |
| $0.790 | RunPod | NVIDIA L40S | PCIe | only made in one form | 1 | on-demand |
| $1.48 | DataCrunch | L40S 48GB | PCIe | only made in one form | 8 | on-demand |
...
| $1.12 | DataCrunch | RTX 6000 Ada 48GB | PCIe | only made in one form | 1 | on-demand |
...
| $0.455 | Vast.ai | RTX A6000 | PCIe | only made in one form | 1 | on-demand |
| $0.616 | DataCrunch | RTX A6000 48GB | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.521 | Vast.ai | RTX 5090 | not stated | nobody says | 1 | on-demand |
...
| $0.457 | Vast.ai | RTX 4090 | not stated | nobody says | 1 | on-demand |
...
| $0.903 * | Scaleway | L4 | PCIe | only made in one form | 1 | on-demand |
...
| $0.182 | DataCrunch | Tesla V100 16GB | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.31 | DataCrunch | B200 SXM6 180GB | SXM | the provider says so | 4 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $2.23 | DataCrunch | H200 SXM5 141GB | SXM | the provider says so | 8 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.69 | DataCrunch | H100 SXM5 80GB | SXM | the provider says so | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.638 | DataCrunch | A100 SXM4 40GB | SXM | the provider says so | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.944 | DataCrunch | RTX PRO 6000 96GB | not stated | nobody says | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.742 | DataCrunch | L40S 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.560 | DataCrunch | RTX 6000 Ada 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.308 | DataCrunch | RTX A6000 48GB | PCIe | only made in one form | 1 | spot |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.0910 | DataCrunch | Tesla V100 16GB | not stated | nobody says | 1 | spot |
...
| [Vast.ai](https://vast.ai) | 152 | 67 | ok | https://console.vast.ai/api/v0/search/asks/ |
...
Vast.ai is the one that needs a number on it. This run asked for 70 GPU names, 43 of which came from sampling the live marketplace rather than from the built in list, and 4 of them had no verified stock. Anything Vast rents under a name outside that set is not in this table.

Full data for all 93 GPU models we saw this run is in [`data/prices.json`](data/prices.json).
<!-- END GENERATED -->
