...
<!-- BEGIN GENERATED -->
Last checked **2026-08-05T12:27:53Z**. 472 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-08-04, 1 EUR = 1.1515 USD.
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $2.20 | Vast.ai | H100 SXM | SXM | the provider says so | 1 | on-demand |
...
| $3.81 * | Scaleway | H100-SXM | SXM | the provider says so | 2 | on-demand |
...
| $3.30 * | Scaleway | H100-PCIe | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.630 | Vast.ai | A100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.550 | Vast.ai | A100 SXM4 | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.482 | Vast.ai | RTX 6000Ada | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.229 | Vast.ai | RTX 4090 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.335 | Vast.ai | L4 | PCIe | only made in one form | 1 | on-demand |
| $0.490 | RunPod | NVIDIA L4 | PCIe | only made in one form | 1 | on-demand |
| $0.907 * | Scaleway | L4 | PCIe | only made in one form | 1 | on-demand |
...
| [RunPod](https://www.runpod.io) | 132 | 44 | ok | https://api.runpod.io/graphql |
