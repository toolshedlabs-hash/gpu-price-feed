...
<!-- BEGIN GENERATED -->
Last checked **2026-08-21T08:08:49Z**. 509 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-08-20, 1 EUR = 1.1681 USD.

> Price moves in this run that are large enough to be worth a second look before you trust them:
>   - vastai GTX 1660 6GB moved from $0.6778 to $0.0704 per GPU hour (9.6x, limit 5.0x)
...
| $7.75 | Vast.ai | B200 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.39 | Vast.ai | H200 NVL | NVL | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.521 | Vast.ai | A100 SXM4 | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.583 | Vast.ai | A100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.943 | Vast.ai | RTX PRO 6000 WS | Workstation | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.316 | Vast.ai | RTX 4090 | not stated | nobody says | 1 | on-demand |
...
| $0.920 * | Scaleway | L4 | PCIe | only made in one form | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 178 | 75 | anomaly | https://console.vast.ai/api/v0/search/asks/ |
