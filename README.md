...
<!-- BEGIN GENERATED -->
Last checked **2026-08-07T09:41:24Z**. 472 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-08-06, 1 EUR = 1.1542 USD.
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $2.58 | Vast.ai | H200 NVL | NVL | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.603 | Vast.ai | A100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $0.442 | Vast.ai | RTX A6000 | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.290 | Vast.ai | RTX 4090 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.112 | Vast.ai | RTX 3090 | not stated | nobody says | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 163 | 66 | ok | https://console.vast.ai/api/v0/search/asks/ |
...
Vast.ai is the one that needs a number on it. This run asked for 65 GPU names, 38 of which came from sampling the live marketplace rather than from the built in list, and 1 of them had no verified stock. Anything Vast rents under a name outside that set is not in this table.
