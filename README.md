...
<!-- BEGIN GENERATED -->
Last checked **2026-07-27T15:57:27Z**. 458 live offers from 8 providers.
...
| $3.97 | Vast.ai | H200 NVL | NVL | the provider says so | 1 | on-demand |

### H200 141GB (form unstated)

| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $4.08 | Vast.ai | H200 | not stated | nobody says | 1 | on-demand |
...
| $2.00 | Vast.ai | H100 PCIE | PCIe | the provider says so | 2 | on-demand |
...
| $3.33 | Vast.ai | H100 NVL | NVL | the provider says so | 4 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.21 | Vast.ai | RTX PRO 6000 S | Server | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.429 | Vast.ai | L40S | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.644 | Vast.ai | RTX 6000Ada | PCIe | only made in one form | 1 | on-demand |
...
| $0.389 | Vast.ai | RTX A6000 | PCIe | only made in one form | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.250 | Vast.ai | RTX 4090 | not stated | nobody says | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.124 | Vast.ai | RTX 3090 | not stated | nobody says | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 157 | 64 | ok | https://console.vast.ai/api/v0/search/asks/ |
...
Vast.ai is the one that needs a number on it. This run asked for 63 GPU names, 36 of which came from sampling the live marketplace rather than from the built in list, and 2 of them had no verified stock. Anything Vast rents under a name outside that set is not in this table.

Full data for all 87 GPU models we saw this run is in [`data/prices.json`](data/prices.json).
<!-- END GENERATED -->
