...
<!-- BEGIN GENERATED -->
Last checked **2026-08-29T12:40:44Z**. 525 live offers from 8 providers.
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.24 | Vast.ai | H200 NVL | NVL | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $3.82 | Vast.ai | H200 | not stated | nobody says | 1 | on-demand |
...
| $2.64 | Vast.ai | H100 NVL | NVL | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.536 | Vast.ai | A100 SXM4 | SXM | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.870 | Vast.ai | RTX PRO 6000 S | Server | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.00 | Vast.ai | RTX PRO 6000 WS | Workstation | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.929 | Vast.ai | RTX PRO 6000 Max-Q | Max-Q | the provider says so | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 194 | 75 | ok | https://console.vast.ai/api/v0/search/asks/ |
...
Vast.ai is the one that needs a number on it. This run asked for 72 GPU names, 45 of which came from sampling the live marketplace rather than from the built in list, and 2 of them had no verified stock. Anything Vast rents under a name outside that set is not in this table.
