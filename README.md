...
<!-- BEGIN GENERATED -->
Last checked **2026-08-25T07:07:52Z**. 513 live offers from 8 providers.

Euro prices converted at the ECB reference rate published 2026-08-24, 1 EUR = 1.1664 USD.
...
| $3.86 * | Scaleway | H100-SXM | SXM | the provider says so | 2 | on-demand |
...
| $2.01 | Vast.ai | H100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.323 | Vast.ai | RTX 5090 | not stated | nobody says | 1 | on-demand |
...
Vast.ai is the one that needs a number on it. This run asked for 68 GPU names, 41 of which came from sampling the live marketplace rather than from the built in list, and 0 of them had no verified stock. Anything Vast rents under a name outside that set is not in this table.
