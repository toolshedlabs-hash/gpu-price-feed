...
<!-- BEGIN GENERATED -->
Last checked **2026-08-02T11:07:39Z**. 459 live offers from 8 providers.
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $1.80 | Vast.ai | H100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.591 | Vast.ai | A100 PCIE | PCIe | the provider says so | 1 | on-demand |
...
| $/GPU/hr | Provider | Listed as | Form | How we know the form | GPUs in config | Type |
|---|---|---|---|---|---|---|
| $0.336 | Vast.ai | L4 | PCIe | only made in one form | 1 | on-demand |
...
| [Vast.ai](https://vast.ai) | 161 | 61 | ok | https://console.vast.ai/api/v0/search/asks/ |
...
Vast.ai is the one that needs a number on it. This run asked for 59 GPU names, 32 of which came from sampling the live marketplace rather than from the built in list, and 1 of them had no verified stock. Anything Vast rents under a name outside that set is not in this table.

Full data for all 84 GPU models we saw this run is in [`data/prices.json`](data/prices.json).
<!-- END GENERATED -->
